            ...
            "shot_breakdown": [
                {
                    ...
                    "composition": "构图",
                    "subtitle_or_audio": {
                        "spoken_audio": "听到的人声/旁白，保留原始语言；没有则写无",
                        "subtitle_text": "画面字幕/屏幕文字，保留原始语言和可见文本；没有则写无",
                        "music_or_sound": "音乐、环境声、音效",
                    },
                    "purpose": "这一段在原视频里的作用",
                    "replaceable_parts": {
                        "product": "产品替换说明",
            ...
            "segment_prompts": [
                {
                    "shot_id": "S01",
                    "time_range": "MM:SS-MM:SS",
                    "prompt": "可复制给视频生成模型的生产级单段 PMT。必须按同 shot_id 的事实拆解完整写出：时间段/片段目标、场景、人物、产品或可替换产品、动作、镜头景别、机位、运镜、光线色彩、构图、质感、字幕原文、旁白原文、音乐/环境声、前后衔接、必须保留项、可替换项。禁止只输出一句视觉摘要。",
