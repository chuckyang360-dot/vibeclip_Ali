...
class XaiImageProvider:
    ...
    def generate_from_text(
        ...
        *,
        ...
        logger.info(
            "[IMAGE_RENDER_STARTED] provider=%s model=%s project_id=%s target_type=%s target_id=%s direct=true",
            _PROVIDER_ID,
            model,
            project_id,
            asset_type,
        ...
        try:
            ...
            logger.warning(
                "[IMAGE_RENDER_FAILED] provider=%s model=%s project_id=%s target_type=%s target_id=%s direct=true",
                _PROVIDER_ID,
                model,
                project_id,
                asset_type,
