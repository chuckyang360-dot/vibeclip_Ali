...
<Tabs>
<Tab zoneid="wgXmpAkrXX" title="基本定义方式">
...
<Tab zoneid="GaFrxChoCE" title="多素材同主体">
...
<Tab zoneid="RsMVigj9p4" title="多主体场景">
...
模型对运镜词理解力很强，直接使用标准运镜术语即可，例如 “中景、特写、全景、缓慢推镜、平稳横移、固定镜头” 。更多请参见[镜头语言](https://www.volcengine.com/docs/82379/1587797#afc80793)。
...
<Tabs>
<Tab zoneid="gCkd78lZa9" title="示例1：宿舍情感短剧（偏文戏 / 对话）">
...
<Tab zoneid="IB1duWj1r1" title="示例2：古风悬崖对手戏（偏动作/氛围）">
