...
export const DEMO_CASES: DemoCaseConfig[] = [
  ...
  // ── 02 女装品牌广告 ──────────────────────────────────────────────
  {
    ...
    create: {
      projectName: "女装品牌TikTok全球短剧",
      duration: "45s",
      format: "single",
      plotStyles: ["twist", "conflict"],
      visualStyle: "premium_ad",
      ratio: "9:16",
    },
    step1: {
  ...
  // ── 03 美妆品牌广告 ──────────────────────────────────────────────
  {
    ...
    create: {
      projectName: "美妆品牌Instagram种草短剧",
      duration: "30s",
      format: "single",
      plotStyles: ["suspense", "emotion"],
      visualStyle: "premium_ad",
      ratio: "9:16",
    },
    step1: {
    ...
    step3: {
      characters: [
        { id: 1, name: "Mia", role: "主角", desc: "27岁时尚博主，皮肤状态是她的核心资产，对护肤有深度研究和独到见解", tags: ["KOL风格", "护肤达人", "自然美"], voice: "温柔神秘", img: "https://readdy.ai/api/search-image?query=young%20asian%20woman%20beauty%20blogger%20glowing%20skin%20natural%20makeup%20portrait%20studio%20clean%20background%20commercial%20advertisement%20skincare%20lifestyle&width=200&height=260&seq=char05&orientation=portrait" },
      ],
      scenes: [
  ...
  // ── 04 网络剧集 ──────────────────────────────────────────────────
  {
    ...
    create: {
      projectName: "深夜食堂都市情感短剧",
      duration: "60s",
      format: "series",
      plotStyles: ["emotion", "comedy"],
      visualStyle: "cinematic",
      ratio: "9:16",
    },
    step1: {
  ...
  // ── 05 独立电影 ──────────────────────────────────────────────────
  {
    ...
    create: {
      projectName: "候鸟独立电影预告片",
      duration: "60s",
      format: "single",
      plotStyles: ["emotion", "suspense"],
      visualStyle: "cinematic",
      ratio: "16:9",
    },
    step1: {
    ...
    step3: {
      ...
      products: [
        { id: 201, name: "候鸟意象", placement: "核心视觉符号", cameraHint: "慢镜头 + 仰拍 + 剪影", style: "诗意自然 · 自由象征", segment: "全片贯穿", img: "https://readdy.ai/api/search-image?query=birds%20silhouette%20flight%20sky%20dramatic%20cinematic%20art%20photography%20poetic%20symbol%20freedom%20migration&width=240&height=180&seq=prod07&orientation=landscape" },
      ],
    },
    overview: {
  ...
  // ── 07 动漫短片 ──────────────────────────────────────────────────
  {
    ...
    create: {
      projectName: "小狐狸城市动漫短片",
      duration: "60s",
      format: "series",
      plotStyles: ["comedy", "emotion"],
    ...
    step3: {
      ...
      products: [
        { id: 201, name: "小狐狸背包", placement: "角色标志性道具", cameraHint: "特写 + 背包细节", style: "可爱森林风 · 原创设计", segment: "全片贯穿", img: "https://readdy.ai/api/search-image?query=cute%20fox%20backpack%20illustration%202d%20animation%20style%20colorful%20kawaii%20design%20product&width=240&height=180&seq=prod09&orientation=landscape" },
      ],
    },
    overview: {
  ...
  // ── 08 运动品牌广告 ──────────────────────────────────────────────
  {
    ...
    create: {
      projectName: "运动品牌全球励志短片",
      duration: "60s",
      format: "single",
      plotStyles: ["conflict", "emotion"],
      visualStyle: "cinematic",
      ratio: "16:9",
    },
    step1: {
